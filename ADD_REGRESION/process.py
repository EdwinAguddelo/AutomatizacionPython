...
def selectDataOfDataFrame(serepite,SoporteConsolidadoDT):
    dat=pd.DataFrame(columns=['Año','SPRINT','PITTs','Aplicación','Tx E2E objetivo','Tx E2E Activas','% Cobertura E2E','Tx Reg objetivo','Tx Reg Activas','% Cobertura Reg','CP Manuales','CP Automáticos','CP Totales','Defectos Manuales','Defectos Automáticos','Defectos Totales','Impacto Alto','Impacto Medio','Impacto Bajo','SPRINT 2'])
